#### CREATE VEGGIES #####
lettuce = Veggie.find_or_create_by(name: 'lettuce') do
  color: 'green-600',
  png: '/assets/lettuce.png'
end

onion = Veggie.find_or_create_by(name: 'onion') do
  color: 'pink-700',
  png: '/assets/onion.png'
end

cabbage = Veggie.find_or_create_by(name: 'cabbage') do
  color: 'fuchsia-800',
  png: '/assets/cabbage.png'
end

pepper = Veggie.find_or_create_by(name: 'pepper') do
  color: 'yellow-400',
  png: '/assets/pepper.png'
end

carrot = Veggie.find_or_create_by(name: 'carrot') do
  color: 'orange-500',
  png: '/assets/carrot.png'
end

tomato = Veggie.find_or_create_by(name: 'tomato') do
  color: 'red-700',
